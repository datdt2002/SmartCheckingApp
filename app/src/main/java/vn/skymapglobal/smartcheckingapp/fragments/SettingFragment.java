...
import vn.skymapglobal.smartcheckingapp.activities.LoginActivity;
...
public class SettingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textView1 = view.findViewById(R.id.txtFullName);
        TextView textView2 = view.findViewById(R.id.txtUsername);

        textView1.setText(user.getFullname());
